...
class MlflowService(Service):
    ...
    # server uri
    tracking_uri: str = "https://dagshub.com/Steven-Herrera/hearts.mlflow"
    registry_uri: str = "https://dagshub.com/Steven-Herrera/hearts.mlflow"
    # experiment
    experiment_name: str = "hearts"
    # registry
    registry_name: str = "hearts"
    # autolog
