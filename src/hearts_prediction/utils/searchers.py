...
class BayesCVSearcher(Searcher):
    """Bayesian optimization searcher with cross-fold validation.
    ...
    KIND: T.Literal["BayesCVSearcher"] = "BayesCVSearcher"
...
SearcherKind = GridCVSearcher | BayesCVSearcher
