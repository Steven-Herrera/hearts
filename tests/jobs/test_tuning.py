...
from hearts_prediction import jobs
from hearts_prediction.core import metrics, models, schemas
from hearts_prediction.io import datasets, services
from hearts_prediction.utils import searchers, splitters
...
def test_tuning_job(
    ...
    searcher: searchers.BayesCVSearcher,
    ...
    assert (
        out["targets_lineage"].targets == schemas.TargetsSchema.HeartDisease
